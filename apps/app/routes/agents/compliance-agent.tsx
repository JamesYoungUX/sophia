    ...
    <div className="flex flex-1 flex-col gap-4 p-4 2xl:p-8 3xl:p-12 4xl:p-16 w-full">
      ...
      <div className="mt-12">
        ...
        <ol className="list-decimal list-inside text-muted-foreground mb-6 space-y-1">
          ...
          <li>
            If patient is on ADT: Notify case manager and add follow-up.
            <br />
            If patient is not on ADT: Chart missed BP measurements and notify
            case manager.
          </li>
        </ol>
        <div className="mb-4">
          ...
          <div style={{ maxWidth: "500px", margin: 0 }}>
            <img
              src="/public/Compliance agent flow.svg"
